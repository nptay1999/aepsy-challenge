...
const useAudioRecorder = (options: UseAudioRecorderOptions = {}): UseAudioRecorderReturn => {
  const {
...
export type { UseAudioRecorderOptions, AudioAnalysisData, UseAudioRecorderReturn }
